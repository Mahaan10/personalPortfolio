...
function About() {
  ...
  return (
    <div
      className="flex pt-[60px] lg:flex-row flex-col gap-y-4 lg:gap-y-0"
      data-aos="fade-down"
    >
      <div className="lg:w-[42%] flex flex-col items-center space-y-2 justify-center">
        <div className="">
          {/* Image need to be defined! */}
          <img
      ...
      <div
        className="lg:w-[58%] flex flex-col mb-4 items-center justify-center lg:mb-0"
        data-aos="fade-left"
        data-aos-duration="1500"
      >
        <div className="max-w-[600px] text-balance mx-3 mb-4">
          <p>
        ...
        <div className="flex items-center gap-x-3 justify-center sm:gap-x-6 mt-10">
          <div className="flex flex-col items-center justify-center">
            ...
            <div className="mt-5 font-light mx-3 md:text-lg text-balance">
              <p>
          ...
          <div className="flex flex-col items-center justify-center ">
            ...
            <div className="mt-5 mr-1 font-light text-balance md:text-lg">
              <p>
