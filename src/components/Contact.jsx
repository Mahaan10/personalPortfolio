  ...
  return (
    <div className="font-ibm pt-[50px] px-5" data-aos="fade-down">
      <div className="flex flex-col gap-y-4">
        ...
        <div className="flex flex-col xl:flex-row gap-y-4 items-center justify-center lg:gap-x-6">
          ...
          <div className="border border-dark-grayish-blue/30 dark:border-neutral-200/20 pt-5 flex flex-col w-full min-[450px]:w-auto mb-6">
            <div className="flex gap-x-2 ml-2">
              <div className="w-20 h-16 -bg-linear-300 from-20% from-myrtle-green dark:from-indigo-dye to-persian-green dark:to-green-blue to-100%  rounded-lg flex items-center justify-center text-neutral-200 p-4 min-[450px]:p-0">
